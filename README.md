...
```javascript
import subBy from 'https://cdn.jsdelivr.net/gh/stdlib-js/math-strided-ops-sub-by@v0.0.1-deno/mod.js';
```

You can also import the following named exports from the package:

```javascript
import { ndarray } from 'https://cdn.jsdelivr.net/gh/stdlib-js/math-strided-ops-sub-by@v0.0.1-deno/mod.js';
```
...
[@stdlib/math/base/ops/sub]: https://github.com/stdlib-js/stdlib/tree/deno
